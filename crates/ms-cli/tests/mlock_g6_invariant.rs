...
//!
//! INLINE COPY of `mnemonic-toolkit/crates/mnemonic-toolkit/tests/mlock_g6_invariant.rs`
//! with the sibling-direction constants reversed. Per Cycle B SPEC §5 +
//! §6 G6 (CI invariant test mirrored in both repos). When updating, mirror
//! the change in BOTH repos in the same PE session.
//!
...
//! - Else `$CARGO_MANIFEST_DIR/../../../mnemonic-toolkit` relative-default
...
const SIBLING_REPO_REL_DEFAULT: &str = "../../../mnemonic-toolkit";
const SIBLING_MLOCK_RELATIVE: &str = "crates/mnemonic-toolkit/src/mlock.rs";
